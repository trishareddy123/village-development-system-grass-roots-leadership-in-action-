...
<div class="container-fluid">
        ...
        <div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
				<form method="post" action="" name="frmusrprfl" onSubmit="return validateform()">
					<div class="body">
                        <div class="row clearfix">
...
{
	if(document.frmuserprfl.username.value == "")
	{
		alert("User name should not be empty..");
		document.frmuserprfl.username.focus();
		return false;
	}
	else if(!document.frmuserprfl.username.value.match(alphaspaceExp))
	{
		alert("User name not valid..");
		document.frmuserprfl.username.focus();
		return false;
	}
	else if(document.frmuserprfl.admissiondate.value == "")
	{
		alert("Admission date should not be empty..");
		document.frmuserprfl.admissiondate.focus();
		return false;
	}
	else if(document.frmuserprfl.admissiontme.value == "")
	{
		alert("Admission time should not be empty..");
		document.frmuserprfl.admissiontme.focus();
		return false;
	}
	else if(document.frmuserprfl.address.value == "")
	{
		alert("Address should not be empty..");
		document.frmuserprfl.address.focus();
		return false;
	}
	else if(document.frmuserprfl.mobilenumber.value == "")
	{
		alert("Mobile number should not be empty..");
		document.frmuserprfl.mobilenumber.focus();
		return false;
	}
	else if(!document.frmuserprfl.mobilenumber.value.match(numericExpression))
	{
		alert("Mobile number not valid..");
		document.frmuserprfl.mobilenumber.focus();
		return false;
	}
	else if(document.frmuserprfl.city.value == "")
	{
		alert("City should not be empty..");
		document.frmuserprfl.city.focus();
		return false;
	}
	else if(!document.frmuserprfl.city.value.match(alphaspaceExp))
	{
		alert("City not valid..");
		document.frmuserprfl.city.focus();
		return false;
	}
	else if(document.frmuserprfl.pincode.value == "")
	{
		alert("Pincode should not be empty..");
		document.frmuserprfl.pincode.focus();
		return false;
	}
	else if(!document.frmuserprfl.pincode.value.match(numericExpression))
	{
		alert("Pincode not valid..");
		document.frmuserprfl.pincode.focus();
		return false;
	}
	else if(document.frmuserprfl.loginid.value == "")
	{
		alert("Login ID should not be empty..");
		document.frmuserprfl.loginid.focus();
		return false;
	}
	else if(!document.frmuserprfl.loginid.value.match(emailExp))
	{
		alert("Login ID not valid..");
		document.frmuserprfl.loginid.focus();
		return false;
	}
	else if(document.frmuserprfl.password.value == "")
	{
		alert("Password should not be empty..");
		document.frmuserprfl.password.focus();
		return false;
	}
	else if(document.frmuserprfl.password.value.length < 8)
	{
		alert("Password length should be more than 8 characters...");
		document.frmuserprfl.password.focus();
		return false;
	}
	else if(document.frmuserprfl.password.value != document.frmuserprfl.confirmpassword.value )
	{
		alert("Password and confirm password should be equal..");
		document.frmuserprfl.confirmpassword.focus();
		return false;
	}
	else if(document.frmuserprfl.select2.value == "")
	{
		alert("Blood Group should not be empty..");
		document.frmuserprfl.select2.focus();
		return false;
	}
	else if(document.frmuserprfl.select3.value == "")
	{
		alert("Gender should not be empty..");
		document.frmuserprfl.select3.focus();
		return false;
	}
	else if(document.frmuserprfl.dateofbirth.value == "")
	{
		alert("Date Of Birth should not be empty..");
		document.frmuserprfl.dateofbirth.focus();
		return false;
	}
	else if(document.frmuserprfl.select.value == "" )
	{
		alert("Kindly select the status..");
		document.frmuserprfl.select.focus();
		return false;
	}
	else
	{
